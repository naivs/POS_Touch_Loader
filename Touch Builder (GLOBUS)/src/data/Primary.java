...
// FIELDS
    ...
    public static final String PAR_PATH = "gd90/P_REGPAR.DAT";
    public static final String REF_PATH = "gd90/S_PLUREF.DAT";
    public static final String BUTTONS_PATH = "gd90/items.dat";
    ...
    public void sortButtonsNames(String buttonIndexes) {
        ...
        for (int j = 0; j < endIndex; j++) {
            ...
            if (buttons[j].getText().equals("")) {
                ...
                while (buttons[endIndex].getText().equals("") && endIndex > j) {
                    endIndex--;
                }
